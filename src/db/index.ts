...
export function putUserSummary (json: any): Promise<QueryResult> {
  return query('INSERT INTO users(id, display_name, last_logoff, profile_url, avatar_url, last_fetch) VALUES ($1, $2, to_timestamp($3), $4, $5, $6)',
...
export function putGameInfo (json: any): Promise<QueryResult> {
  ...
  return query('INSERT INTO games(id, name, description, image_url, screenshots, last_fetch) VALUES ($1, $2, $3, $4, $5, $6)',
               [app_id, json.name, json.short_description, json.header_image, json.screenshots.map((s: any) => s.path_full), new Date().toISOString()])
}
